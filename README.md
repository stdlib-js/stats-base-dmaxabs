...
```javascript
dmaxabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmaxabs@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dmaxabs/tags). For example,

```javascript
dmaxabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmaxabs@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dmaxabs = require( 'path/to/vendor/umd/stats-base-dmaxabs/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmaxabs@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-dmaxabs.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-dmaxabs

[test-image]: https://github.com/stdlib-js/stats-base-dmaxabs/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-dmaxabs/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-dmaxabs/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-dmaxabs?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-dmaxabs.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-dmaxabs/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-dmaxabs/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-dmaxabs/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-dmaxabs/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-dmaxabs/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-dmaxabs/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-dmaxabs/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-dmaxabs/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-dmaxabs/main/LICENSE
